...
import com.assesment.cinemaslist.databinding.FragmentCinemaDetailsBinding
import com.assesment.cinemaslist.util.Status
...
class CinemaDetailsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding = FragmentCinemaDetailsBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    private fun subscribeObservers() {
        ...
        viewModel.cinemaDetails.observe(viewLifecycleOwner) { result ->
            when(result.status) {
                Status.LOADING -> {
